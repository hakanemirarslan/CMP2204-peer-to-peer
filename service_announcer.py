...
class User:
    ...
    def connect_to(self, broadcast, port):
        ...
        addr = (broadcast, port) #s.setsockopt(socket.SOL_SOCKET,socket.SO_BROADCAST,1) macOS’da denerken bu satır olmadığında Access hatası veriyordu bu şekilde izin alınmış oldu
        while True:
